#include "DirectionalGravityPlayerController.h"
#include "GameFramework/Character.h"
#include "GameFramework/CharacterMovementComponent.h"

void ADirectionalGravityPlayerController::UpdateRotation(float DeltaTime)
{
...
FRotator ADirectionalGravityPlayerController::GetGravityRelativeRotation(FRotator Rotation, FVector GravityDirection)
{
...
FRotator ADirectionalGravityPlayerController::GetGravityWorldRotation(FRotator Rotation, FVector GravityDirection)
{
	if (!GravityDirection.Equals(FVector::DownVector))
	{
