...
struct FAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTaggedAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
struct FAnimBodyStyleSelectionSet
{
	...
	TArray<FAnimBodyStyleSelectionEntry> MeshRules;
