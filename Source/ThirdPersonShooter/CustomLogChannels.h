...
THIRDPERSONSHOOTER_API DECLARE_LOG_CATEGORY_EXTERN(LogMe, Log, All);
...
THIRDPERSONSHOOTER_API DECLARE_LOG_CATEGORY_EXTERN(LogEquipment, Log, All);
THIRDPERSONSHOOTER_API DECLARE_LOG_CATEGORY_EXTERN(GameFeatures, Log, All);
