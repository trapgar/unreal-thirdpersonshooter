...
struct THIRDPERSONSHOOTER_API FContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct THIRDPERSONSHOOTER_API FContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct THIRDPERSONSHOOTER_API FContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct THIRDPERSONSHOOTER_API FContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/ThirdPersonShooter.ContextEffectsLibrary"))
...
class THIRDPERSONSHOOTER_API UAnimNotify_ContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_ContextEffects();
