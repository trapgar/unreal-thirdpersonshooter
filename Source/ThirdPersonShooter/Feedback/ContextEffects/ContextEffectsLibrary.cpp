...
void UContextEffectsLibrary::LoadEffectsInternal()
{
	...
	this->ContextEffectLibraryLoadingComplete(ActiveContextEffectsArray);
}

void UContextEffectsLibrary::ContextEffectLibraryLoadingComplete(
	TArray<UActiveContextEffects*> NewActiveContextEffects)
{
	// Flag data as loaded
