...
struct THIRDPERSONSHOOTER_API FContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class THIRDPERSONSHOOTER_API UActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class THIRDPERSONSHOOTER_API UContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
...
private:
	...
	void ContextEffectLibraryLoadingComplete(TArray<UActiveContextEffects*> ActiveContextEffects);
