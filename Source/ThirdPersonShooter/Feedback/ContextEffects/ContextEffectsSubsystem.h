...
class THIRDPERSONSHOOTER_API UContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class THIRDPERSONSHOOTER_API UContextEffectsSet : public UObject
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class THIRDPERSONSHOOTER_API UContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
