...
#include "CustomGameFeaturePolicy.generated.h"
...
class UCustomGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	THIRDPERSONSHOOTER_API static UCustomGameFeaturePolicy& Get();

	UCustomGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
