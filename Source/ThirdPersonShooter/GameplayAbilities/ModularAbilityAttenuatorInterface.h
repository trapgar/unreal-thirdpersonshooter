...
#include "ModularAbilityAttenuatorInterface.generated.h"
...
class IModularAbilityAttenuatorInterface
{
	...
	/**
	 * Compute the multiplier for a physical material
	 * 
	 * @param PhysicalMaterial	Physical material that of the target
	 * @param SourceTags		Aggregated Tags from the source
	 * @param TargetTags		Aggregated Tags currently on the target
	 * 
	 * @return Multiplier to apply to the base attribute value due to distance
