...
#include "GameplayVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GameplayVerbMessageHelpers)
...
APlayerState* UGameplayVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UGameplayVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UGameplayVerbMessageHelpers::VerbMessageToCueParameters(const FGameplayVerbMessage& Message)
{
...
FGameplayVerbMessage UGameplayVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
