...
#include "VehicleSpaceShip.generated.h"
...
class THIRDPERSONSHOOTER_API AVehicleSpaceShip : public APawn, public IAbilitySystemInterface, public IGameplayCueInterface, public IGameplayTagAssetInterface
{
	GENERATED_BODY()
